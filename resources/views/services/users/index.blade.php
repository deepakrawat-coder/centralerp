                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 mb-2 date-range-input">
                                <input type="text" class="datepicker-here form-control digits" data-multiple-dates="3"
                                    data-multiple-dates-separator=", "data-language="en" id="created_AT"
            ...
            userTable = $('#users-table').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'Address',
                        render: function(data, type, row) {
                            return `${row.Address ?? ''} ${row.District ?? ''} ${row.State ?? ''} ${row.Pincode ?? ''}`
                                .trim();
                        }
                    },
                    {
                        ...
                        render: function(status) {
                            return status == 1 ? '<span class="badge bg-success">Active</span>' :
